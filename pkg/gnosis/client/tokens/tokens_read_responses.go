...
func (o *TokensReadOK) Error() string {
	return fmt.Sprintf("[GET /tokens/{address}/][%d] tokensReadOK  %+v", 200, o.Payload)
}
func (o *TokensReadOK) GetPayload() *models.TokenInfoResponse {
	return o.Payload
}
