...
/* ContractsReadOK describes a response with status code 200, with default header values.
...
func (o *ContractsReadOK) Error() string {
	return fmt.Sprintf("[GET /contracts/{address}/][%d] contractsReadOK  %+v", 200, o.Payload)
}
func (o *ContractsReadOK) GetPayload() *models.Contract {
	return o.Payload
}
